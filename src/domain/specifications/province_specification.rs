//! Specifications for Province aggregate
//!
...
// Each predicate implements `Specification<Province>` and can be combined
...
//
// pub struct ActiveProvinceSpec;
// impl Specification<Province> for ActiveProvinceSpec {
//     fn is_satisfied_by(&self, e: &Province) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
