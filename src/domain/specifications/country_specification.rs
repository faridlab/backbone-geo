//! Specifications for Country aggregate
//!
...
// Each predicate implements `Specification<Country>` and can be combined
...
//
// pub struct ActiveCountrySpec;
// impl Specification<Country> for ActiveCountrySpec {
//     fn is_satisfied_by(&self, e: &Country) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
